...
cv2.imwrite('imagem_pulmao_k_=_{:}.png'.format(K),image)
...
show_image('Gráfico Lab', lab_image)

plt.figure('Canal L')
ax = plt.axes(projection='3d')

ax.plot_surface(X, Y, lab_image[:, :, 0], cmap='inferno')
...
# gist_yarg, gist_yarg_r, gnuplot, gnuplot2, gnuplot2_r, gnuplot_r, gray, gray_r, hot, hot_r, hsv, hsv_r, inferno, inferno_r, jet,
# jet_r, magma, magma_r, nipy_spectral, nipy_spectral_r, ocean, ocean_r, pink, pink_r, plasma, plasma_r, prism, prism_r, rainbow, rainbow_r,
